...
function formatBody() {
  ...
  // grab div hero-body-column-video
  var heroBodyElementVideo = document.getElementById('hero-body-column-video');

  //createFigure()
  var videoFigureElement = createFigure();
  videoFigureElement.classList.add('image', 'is-16by9');
  ...
  heroBodyElementVideo.appendChild(videoFigureElement);
